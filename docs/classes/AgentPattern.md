# Information technology - City data model - Part 1: Foundation level concepts - Agent Pattern
...
- [performedBy](../properties/performedBy.md)
- [performs](../properties/performs.md)


The formal definition of this pattern is available in TURTLE Syntax in two files, the [core semantics](../AgentPattern.ttl) and the SHACL [restrictions](../AgentSHACL.ttl).
